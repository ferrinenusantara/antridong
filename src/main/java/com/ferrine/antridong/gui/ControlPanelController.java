...
public class ControlPanelController {
    ...
    @FXML
    private void openSetupUser() { openSetupWindow("/gui/SetupUser.fxml", "Setup User"); }

    @FXML
    private void openSetupKategori() { openSetupWindow("/gui/SetupKategori.fxml", "Setup Kategori Antrian"); }

    @FXML
    private void openSetupCounter() { openSetupWindow("/gui/SetupCounter.fxml", "Setup Counter"); }
